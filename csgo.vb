...
Namespace hazedumper
    Public Const timestamp as Integer = &H5C636981
    ...
    Public Shared Class signatures
        ...
        Public Const dwEntityList as Integer = &H4CD9FEC
        Public Const dwForceAttack as Integer = &H310B690
        Public Const dwForceAttack2 as Integer = &H310B69C
        Public Const dwForceBackward as Integer = &H310B6D8
        Public Const dwForceForward as Integer = &H310B6E4
        Public Const dwForceJump as Integer = &H517D1A4
        Public Const dwForceLeft as Integer = &H310B6FC
        Public Const dwForceRight as Integer = &H310B6F0
        Public Const dwGameDir as Integer = &H631F70
        Public Const dwGameRulesProxy as Integer = &H51EF4E4
        Public Const dwGetAllClasses as Integer = &HCED9D4
        Public Const dwGlobalVars as Integer = &H58BA00
        Public Const dwGlowObjectManager as Integer = &H5219F38
        Public Const dwInput as Integer = &H5124D80
        Public Const dwInterfaceLinkList as Integer = &H8A76D4
        ...
        Public Const dwPlayerResource as Integer = &H3109A4C
        Public Const dwRadarBase as Integer = &H510ED2C
        ...
        Public Const dwViewMatrix as Integer = &H4CCBA04
        Public Const dwWeaponTable as Integer = &H5125844
        ...
        Public Const m_pitchClassPtr as Integer = &H510EFE0
