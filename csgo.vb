...
Namespace hazedumper
    Public Const timestamp as Integer = &H5C753C5C
    ...
    Public Shared Class signatures
        ...
        Public Const dwEntityList as Integer = &H4CDB07C
        Public Const dwForceAttack as Integer = &H310C780
        Public Const dwForceAttack2 as Integer = &H310C78C
        Public Const dwForceBackward as Integer = &H310C738
        Public Const dwForceForward as Integer = &H310C7A4
        Public Const dwForceJump as Integer = &H517E234
        Public Const dwForceLeft as Integer = &H310C72C
        Public Const dwForceRight as Integer = &H310C750
        Public Const dwGameDir as Integer = &H631F70
        Public Const dwGameRulesProxy as Integer = &H51F0574
        Public Const dwGetAllClasses as Integer = &HCEEA5C
        Public Const dwGlobalVars as Integer = &H58BA00
        Public Const dwGlowObjectManager as Integer = &H521AFA8
        Public Const dwInput as Integer = &H5125E10
        Public Const dwInterfaceLinkList as Integer = &H8A8AD4
        Public Const dwLocalPlayer as Integer = &HCCA6B4
        Public Const dwMouseEnable as Integer = &HCD0200
        Public Const dwMouseEnablePtr as Integer = &HCD01D0
        Public Const dwPlayerResource as Integer = &H310AADC
        Public Const dwRadarBase as Integer = &H510FDBC
        Public Const dwSensitivity as Integer = &HCD009C
        Public Const dwSensitivityPtr as Integer = &HCD0070
        Public Const dwSetClanTag as Integer = &H896A0
        Public Const dwViewMatrix as Integer = &H4CCCA94
        Public Const dwWeaponTable as Integer = &H51268D4
        Public Const dwWeaponTableIndex as Integer = &H323C
        Public Const dwYawPtr as Integer = &HCCFE60
        Public Const dwZoomSensitivityRatioPtr as Integer = &HCD50A0
        Public Const dwbSendPackets as Integer = &HD234A
        Public Const dwppDirect3DDevice9 as Integer = &HA3FC0
        Public Const force_update_spectator_glow as Integer = &H38D2D2
        Public Const interface_engine_cvar as Integer = &H3E9EC
        Public Const is_c4_owner as Integer = &H399370
        Public Const m_bDormant as Integer = &HED
        Public Const m_pStudioHdr as Integer = &H294C
        Public Const m_pitchClassPtr as Integer = &H5110070
        Public Const m_yawClassPtr as Integer = &HCCFE60
