...
Namespace hazedumper
    Public Const timestamp as Integer = &H6177E024
    ...
    Public Shared Class signatures
        ...
        Public Const dwEntityList as Integer = &H4DBF73C
        Public Const dwForceAttack as Integer = &H31EFCB4
        Public Const dwForceAttack2 as Integer = &H31EFCC0
        Public Const dwForceBackward as Integer = &H31EFC6C
        Public Const dwForceForward as Integer = &H31EFC78
        Public Const dwForceJump as Integer = &H5269550
        Public Const dwForceLeft as Integer = &H31EFC90
        Public Const dwForceRight as Integer = &H31EFC84
        Public Const dwGameDir as Integer = &H627700
        Public Const dwGameRulesProxy as Integer = &H52DC82C
        Public Const dwGetAllClasses as Integer = &HDCDA94
        Public Const dwGlobalVars as Integer = &H588CF0
        Public Const dwGlowObjectManager as Integer = &H5307C30
        Public Const dwInput as Integer = &H5210D00
        Public Const dwInterfaceLinkList as Integer = &H956BF4
        Public Const dwLocalPlayer as Integer = &HDA545C
        Public Const dwMouseEnable as Integer = &HDAAFA8
        Public Const dwMouseEnablePtr as Integer = &HDAAF78
        Public Const dwPlayerResource as Integer = &H31EDFE0
        Public Const dwRadarBase as Integer = &H51F44B4
        Public Const dwSensitivity as Integer = &HDAAE44
        Public Const dwSensitivityPtr as Integer = &HDAAE18
        Public Const dwSetClanTag as Integer = &H8A130
        Public Const dwViewMatrix as Integer = &H4DB1054
        Public Const dwWeaponTable as Integer = &H52117C4
        Public Const dwWeaponTableIndex as Integer = &H326C
        Public Const dwYawPtr as Integer = &HDAAC08
        Public Const dwZoomSensitivityRatioPtr as Integer = &HDAFEA8
        Public Const dwbSendPackets as Integer = &HD7BD2
        Public Const dwppDirect3DDevice9 as Integer = &HA7050
        Public Const find_hud_element as Integer = &H2D862EA0
        ...
        Public Const m_pitchClassPtr as Integer = &H51F4750
        Public Const m_yawClassPtr as Integer = &HDAAC08
