' 2020-02-04 18:20:27.110815500 UTC

Namespace hazedumper
    Public Const timestamp as Integer = &H5E39B5EB
    ...
    Public Shared Class signatures
        ...
        Public Const dwEntityList as Integer = &H4D3D66C
        Public Const dwForceAttack as Integer = &H316ED20
        Public Const dwForceAttack2 as Integer = &H316ED2C
        Public Const dwForceBackward as Integer = &H316ED74
        Public Const dwForceForward as Integer = &H316ED50
        Public Const dwForceJump as Integer = &H51E0E90
        Public Const dwForceLeft as Integer = &H316ED68
        Public Const dwForceRight as Integer = &H316ED8C
        Public Const dwGameDir as Integer = &H6274F8
        Public Const dwGameRulesProxy as Integer = &H525416C
        Public Const dwGetAllClasses as Integer = &HD4FCDC
        Public Const dwGlobalVars as Integer = &H588AA0
        Public Const dwGlowObjectManager as Integer = &H527EF00
        Public Const dwInput as Integer = &H5188808
        Public Const dwInterfaceLinkList as Integer = &H8F5654
        Public Const dwLocalPlayer as Integer = &HD29B0C
        Public Const dwMouseEnable as Integer = &HD2F6B0
        Public Const dwMouseEnablePtr as Integer = &HD2F680
        Public Const dwPlayerResource as Integer = &H316D0AC
        Public Const dwRadarBase as Integer = &H51723CC
        Public Const dwSensitivity as Integer = &HD2F54C
        Public Const dwSensitivityPtr as Integer = &HD2F520
        Public Const dwSetClanTag as Integer = &H89D60
        Public Const dwViewMatrix as Integer = &H4D2F084
        Public Const dwWeaponTable as Integer = &H51892CC
        Public Const dwWeaponTableIndex as Integer = &H324C
        Public Const dwYawPtr as Integer = &HD2F310
        Public Const dwZoomSensitivityRatioPtr as Integer = &HD34530
        Public Const dwbSendPackets as Integer = &HD36FA
        Public Const dwppDirect3DDevice9 as Integer = &HA6030
        Public Const find_hud_element as Integer = &H26F0B6C0
        Public Const force_update_spectator_glow as Integer = &H397F32
        Public Const interface_engine_cvar as Integer = &H3E9EC
        Public Const is_c4_owner as Integer = &H3A4360
        ...
        Public Const m_pitchClassPtr as Integer = &H5172668
        Public Const m_yawClassPtr as Integer = &HD2F310
        Public Const model_ambient_min as Integer = &H58BDBC
        Public Const set_abs_angles as Integer = &H1CEC00
        Public Const set_abs_origin as Integer = &H1CEA40
    End Class
End Namespace
