' 2019-05-01 10:59:35.862249100 UTC

Namespace hazedumper
    Public Const timestamp as Integer = &H5CC97C17
    ...
    Public Shared Class signatures
        ...
        Public Const dwEntityList as Integer = &H4CFC35C
        Public Const dwForceAttack as Integer = &H312DA5C
        Public Const dwForceAttack2 as Integer = &H312DA68
        Public Const dwForceBackward as Integer = &H312DA14
        Public Const dwForceForward as Integer = &H312DA20
        Public Const dwForceJump as Integer = &H519F8A8
        Public Const dwForceLeft as Integer = &H312DA38
        Public Const dwForceRight as Integer = &H312DA2C
        Public Const dwGameDir as Integer = &H631F70
        Public Const dwGameRulesProxy as Integer = &H5211BEC
        Public Const dwGetAllClasses as Integer = &HD0F5EC
        Public Const dwGlobalVars as Integer = &H58BA00
        Public Const dwGlowObjectManager as Integer = &H523C700
        Public Const dwInput as Integer = &H5147390
        Public Const dwInterfaceLinkList as Integer = &H8C15D4
        Public Const dwLocalPlayer as Integer = &HCEA96C
        Public Const dwMouseEnable as Integer = &HCF04B8
        Public Const dwMouseEnablePtr as Integer = &HCF0488
        Public Const dwPlayerResource as Integer = &H312BDAC
        Public Const dwRadarBase as Integer = &H513109C
        Public Const dwSensitivity as Integer = &HCF0354
        Public Const dwSensitivityPtr as Integer = &HCF0328
        Public Const dwSetClanTag as Integer = &H896A0
        Public Const dwViewMatrix as Integer = &H4CEDD74
        Public Const dwWeaponTable as Integer = &H5147E50
        Public Const dwWeaponTableIndex as Integer = &H323C
        Public Const dwYawPtr as Integer = &HCF0118
        Public Const dwZoomSensitivityRatioPtr as Integer = &HCF5358
        Public Const dwbSendPackets as Integer = &HD271A
        Public Const dwppDirect3DDevice9 as Integer = &HA6030
        Public Const force_update_spectator_glow as Integer = &H390DB2
        Public Const interface_engine_cvar as Integer = &H3E9EC
        Public Const is_c4_owner as Integer = &H39D440
        Public Const m_bDormant as Integer = &HED
        Public Const m_pStudioHdr as Integer = &H294C
        Public Const m_pitchClassPtr as Integer = &H5131350
        Public Const m_yawClassPtr as Integer = &HCF0118
        Public Const model_ambient_min as Integer = &H58ED1C
        Public Const set_abs_angles as Integer = &H1C9670
        Public Const set_abs_origin as Integer = &H1C94B0
    End Class
End Namespace
