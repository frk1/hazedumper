...
Namespace hazedumper
    Public Const timestamp as Integer = &H5F1B0837
    ...
    Public Shared Class signatures
        ...
        Public Const dwEntityList as Integer = &H4D5348C
        Public Const dwForceAttack as Integer = &H31849E4
        Public Const dwForceAttack2 as Integer = &H31849F0
        Public Const dwForceBackward as Integer = &H3184A38
        Public Const dwForceForward as Integer = &H3184A14
        Public Const dwForceJump as Integer = &H51FD154
        Public Const dwForceLeft as Integer = &H3184A2C
        Public Const dwForceRight as Integer = &H3184A50
        Public Const dwGameDir as Integer = &H6296F8
        Public Const dwGameRulesProxy as Integer = &H527044C
        Public Const dwGetAllClasses as Integer = &HD652AC
        Public Const dwGlobalVars as Integer = &H58AAD8
        Public Const dwGlowObjectManager as Integer = &H529B2F0
        Public Const dwInput as Integer = &H51A4A68
        Public Const dwInterfaceLinkList as Integer = &H907734
        Public Const dwLocalPlayer as Integer = &HD3EC4C
        Public Const dwMouseEnable as Integer = &HD447F0
        Public Const dwMouseEnablePtr as Integer = &HD447C0
        Public Const dwPlayerResource as Integer = &H3182D70
        Public Const dwRadarBase as Integer = &H51881FC
        Public Const dwSensitivity as Integer = &HD4468C
        Public Const dwSensitivityPtr as Integer = &HD44660
        Public Const dwSetClanTag as Integer = &H89FB0
        Public Const dwViewMatrix as Integer = &H4D44DD4
        Public Const dwWeaponTable as Integer = &H51A5528
        Public Const dwWeaponTableIndex as Integer = &H325C
        Public Const dwYawPtr as Integer = &HD44450
        Public Const dwZoomSensitivityRatioPtr as Integer = &HD49698
        Public Const dwbSendPackets as Integer = &HD415A
        Public Const dwppDirect3DDevice9 as Integer = &HA7030
        Public Const find_hud_element as Integer = &H2CA43630
        ...
        Public Const m_pitchClassPtr as Integer = &H5188498
        Public Const m_yawClassPtr as Integer = &HD44450
