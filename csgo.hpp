...
constexpr ::std::ptrdiff_t dwEntityList = 0x4AADC44;
constexpr ::std::ptrdiff_t dwForceAttack = 0x2EEDC98;
constexpr ::std::ptrdiff_t dwForceJump = 0x4F4476C;
constexpr ::std::ptrdiff_t dwGameDir = 0x65E518;
constexpr ::std::ptrdiff_t dwGlobalVars = 0xA803A4;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x4FC5044;
constexpr ::std::ptrdiff_t dwInput = 0x4EF87A0;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xA8C53C;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x2EEBE74;
constexpr ::std::ptrdiff_t dwRadarBase = 0x4EE29AC;
constexpr ::std::ptrdiff_t dwSensitivity = 0xA91D44;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xA91D18;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4A9F7E4;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x4EF4E0C;
