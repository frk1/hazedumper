...
constexpr ::std::ptrdiff_t dwClientState = 0x5CD594;
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4AD4B04;
constexpr ::std::ptrdiff_t dwForceAttack = 0x2F14AF0;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x2F14AE4;
constexpr ::std::ptrdiff_t dwForceBackward = 0x2F14B44;
constexpr ::std::ptrdiff_t dwForceForward = 0x2F14B20;
constexpr ::std::ptrdiff_t dwForceJump = 0x4F6B728;
constexpr ::std::ptrdiff_t dwForceLeft = 0x2F14B38;
constexpr ::std::ptrdiff_t dwForceRight = 0x2F14B5C;
constexpr ::std::ptrdiff_t dwGameDir = 0x66C3E8;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x2F12D74;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0x2F12E28;
constexpr ::std::ptrdiff_t dwGlobalVars = 0xAA53A0;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x4FEF60C;
constexpr ::std::ptrdiff_t dwInput = 0x4F1F650;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x72DFC4;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xAB1708;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xAB6F50;
constexpr ::std::ptrdiff_t dwMouseEnablePtr = 0xAB6F20;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x2F12D2C;
constexpr ::std::ptrdiff_t dwRadarBase = 0x4F0987C;
constexpr ::std::ptrdiff_t dwSensitivity = 0xAB6EF4;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xAB6EC8;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4AC66A4;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x4F1BC7C;
constexpr ::std::ptrdiff_t dwWeaponTableIndex = 0x3270;
constexpr ::std::ptrdiff_t dwYawPtr = 0xAB6DC0;
constexpr ::std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xABBBD0;
constexpr ::std::ptrdiff_t dwbSendPackets = 0xE5E3A;
constexpr ::std::ptrdiff_t dwppDirect3DDevice9 = 0x99AA0;
constexpr ::std::ptrdiff_t dwSetClanTag = 0x9E570;
