...
constexpr ::std::int64_t timestamp = 1627476337;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4DA31DC;
constexpr ::std::ptrdiff_t dwForceAttack = 0x31D3704;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x31D3710;
constexpr ::std::ptrdiff_t dwForceBackward = 0x31D374C;
constexpr ::std::ptrdiff_t dwForceForward = 0x31D3758;
constexpr ::std::ptrdiff_t dwForceJump = 0x524CFCC;
constexpr ::std::ptrdiff_t dwForceLeft = 0x31D3770;
constexpr ::std::ptrdiff_t dwForceRight = 0x31D3764;
constexpr ::std::ptrdiff_t dwGameDir = 0x627780;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x52C02BC;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xDB202C;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x588CF0;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x52EB650;
constexpr ::std::ptrdiff_t dwInput = 0x51F47A0;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x944E34;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xD8A2DC;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xD8FE28;
constexpr ::std::ptrdiff_t dwMouseEnablePtr = 0xD8FDF8;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x31D1A90;
constexpr ::std::ptrdiff_t dwRadarBase = 0x51D7F54;
constexpr ::std::ptrdiff_t dwSensitivity = 0xD8FCC4;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xD8FC98;
constexpr ::std::ptrdiff_t dwSetClanTag = 0x8A1B0;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D94AF4;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x51F5260;
constexpr ::std::ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ::std::ptrdiff_t dwYawPtr = 0xD8FA88;
constexpr ::std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xD94D28;
constexpr ::std::ptrdiff_t dwbSendPackets = 0xD779A;
constexpr ::std::ptrdiff_t dwppDirect3DDevice9 = 0xA7050;
constexpr ::std::ptrdiff_t find_hud_element = 0x5A10F720;
...
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x51D81F0;
constexpr ::std::ptrdiff_t m_yawClassPtr = 0xD8FA88;
