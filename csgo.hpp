...
constexpr ::std::ptrdiff_t dwEntityList = 0x4A9F6D4;
constexpr ::std::ptrdiff_t dwForceAttack = 0x2EDF6D0;
constexpr ::std::ptrdiff_t dwForceJump = 0x4F34A68;
constexpr ::std::ptrdiff_t dwGameDir = 0x6AE698;
constexpr ::std::ptrdiff_t dwGlobalVars = 0xA7839C;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x4FB556C;
constexpr ::std::ptrdiff_t dwInput = 0x4EEA140;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xA844DC;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xA89D40;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x2EDD6F4;
constexpr ::std::ptrdiff_t dwRadarBase = 0x4ED442C;
constexpr ::std::ptrdiff_t dwSensitivity = 0xA89CE4;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4A91264;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x4EE683C;
