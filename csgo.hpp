...
constexpr ::std::int64_t timestamp = 1591201622;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4D4B154;
constexpr ::std::ptrdiff_t dwForceAttack = 0x317C70C;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x317C718;
constexpr ::std::ptrdiff_t dwForceBackward = 0x317C760;
constexpr ::std::ptrdiff_t dwForceForward = 0x317C76C;
constexpr ::std::ptrdiff_t dwForceJump = 0x51F4DD8;
constexpr ::std::ptrdiff_t dwForceLeft = 0x317C6E8;
constexpr ::std::ptrdiff_t dwForceRight = 0x317C6DC;
constexpr ::std::ptrdiff_t dwGameDir = 0x6286F8;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x52680CC;
...
constexpr ::std::ptrdiff_t dwInput = 0x519C6E8;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x8FFF74;
...
constexpr ::std::ptrdiff_t dwPlayerResource = 0x317AA8C;
constexpr ::std::ptrdiff_t dwRadarBase = 0x517FEAC;
...
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D3CA84;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x519D1AC;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2755FED0;
...
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x5180150;
