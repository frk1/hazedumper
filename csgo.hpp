...
// 2020-06-16 13:16:02.293339600 UTC

namespace hazedumper {
constexpr ::std::int64_t timestamp = 1592313362;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4D4E21C;
constexpr ::std::ptrdiff_t dwForceAttack = 0x317F750;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x317F75C;
constexpr ::std::ptrdiff_t dwForceBackward = 0x317F798;
constexpr ::std::ptrdiff_t dwForceForward = 0x317F7A4;
constexpr ::std::ptrdiff_t dwForceJump = 0x51F7EB4;
constexpr ::std::ptrdiff_t dwForceLeft = 0x317F7BC;
constexpr ::std::ptrdiff_t dwForceRight = 0x317F7B0;
constexpr ::std::ptrdiff_t dwGameDir = 0x6296F8;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x526B1AC;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xD6003C;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x58AAD8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x5296060;
constexpr ::std::ptrdiff_t dwInput = 0x519F7C8;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x904084;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xD39BEC;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xD3F790;
constexpr ::std::ptrdiff_t dwMouseEnablePtr = 0xD3F760;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x317DB00;
constexpr ::std::ptrdiff_t dwRadarBase = 0x5182F8C;
constexpr ::std::ptrdiff_t dwSensitivity = 0xD3F62C;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xD3F600;
constexpr ::std::ptrdiff_t dwSetClanTag = 0x89FB0;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D3FB64;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x51A0288;
constexpr ::std::ptrdiff_t dwWeaponTableIndex = 0x325C;
constexpr ::std::ptrdiff_t dwYawPtr = 0xD3F3F0;
constexpr ::std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xD44638;
constexpr ::std::ptrdiff_t dwbSendPackets = 0xD415A;
constexpr ::std::ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
constexpr ::std::ptrdiff_t find_hud_element = 0x291D1B30;
constexpr ::std::ptrdiff_t force_update_spectator_glow = 0x3A06E2;
constexpr ::std::ptrdiff_t interface_engine_cvar = 0x3E9EC;
constexpr ::std::ptrdiff_t is_c4_owner = 0x3AD190;
constexpr ::std::ptrdiff_t m_bDormant = 0xED;
constexpr ::std::ptrdiff_t m_flSpawnTime = 0xA370;
constexpr ::std::ptrdiff_t m_pStudioHdr = 0x294C;
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x5183228;
constexpr ::std::ptrdiff_t m_yawClassPtr = 0xD3F3F0;
constexpr ::std::ptrdiff_t model_ambient_min = 0x58DE4C;
constexpr ::std::ptrdiff_t set_abs_angles = 0x1D49B0;
constexpr ::std::ptrdiff_t set_abs_origin = 0x1D47F0;
} // namespace signatures
} // namespace hazedumper
