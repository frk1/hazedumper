...
constexpr ::std::ptrdiff_t dwEntityList = 0x4DD348C;
constexpr ::std::ptrdiff_t dwForceAttack = 0x3203940;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x320394C;
constexpr ::std::ptrdiff_t dwForceBackward = 0x320397C;
constexpr ::std::ptrdiff_t dwForceForward = 0x3203970;
constexpr ::std::ptrdiff_t dwForceJump = 0x527D3A0;
constexpr ::std::ptrdiff_t dwForceLeft = 0x3203988;
constexpr ::std::ptrdiff_t dwForceRight = 0x3203994;
constexpr ::std::ptrdiff_t dwGameDir = 0x62B900;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x52F0BCC;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xDE177C;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x58CCC8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x531C090;
constexpr ::std::ptrdiff_t dwInput = 0x5224A60;
...
constexpr ::std::ptrdiff_t dwPlayerResource = 0x3201CF0;
constexpr ::std::ptrdiff_t dwRadarBase = 0x5208204;
...
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4DC4DA4;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x5225524;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2E595200;
...
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x52084A0;
