...
constexpr ::std::int64_t timestamp = 1616664829;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4DA3F44;
constexpr ::std::ptrdiff_t dwForceAttack = 0x31D54A4;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x31D54B0;
constexpr ::std::ptrdiff_t dwForceBackward = 0x31D54F8;
constexpr ::std::ptrdiff_t dwForceForward = 0x31D5504;
constexpr ::std::ptrdiff_t dwForceJump = 0x524DEA4;
constexpr ::std::ptrdiff_t dwForceLeft = 0x31D5480;
constexpr ::std::ptrdiff_t dwForceRight = 0x31D5474;
constexpr ::std::ptrdiff_t dwGameDir = 0x62D7F8;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x52C118C;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xDB3F9C;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x58ECE8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x52EC558;
constexpr ::std::ptrdiff_t dwInput = 0x51F5528;
...
constexpr ::std::ptrdiff_t dwPlayerResource = 0x31D3800;
constexpr ::std::ptrdiff_t dwRadarBase = 0x51D8CBC;
...
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D95844;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x51F5FE8;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2653E320;
...
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x51D8F58;
