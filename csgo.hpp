...
constexpr ::std::int64_t timestamp = 1574120264;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwEntityList = 0x4D3858C;
constexpr ::std::ptrdiff_t dwForceAttack = 0x3169C4C;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x3169C58;
constexpr ::std::ptrdiff_t dwForceBackward = 0x3169CA0;
constexpr ::std::ptrdiff_t dwForceForward = 0x3169CAC;
constexpr ::std::ptrdiff_t dwForceJump = 0x51DBD78;
constexpr ::std::ptrdiff_t dwForceLeft = 0x3169C28;
constexpr ::std::ptrdiff_t dwForceRight = 0x3169C1C;
constexpr ::std::ptrdiff_t dwGameDir = 0x62F4F0;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x524F064;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xD4AC44;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x588AC8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x5279B58;
constexpr ::std::ptrdiff_t dwInput = 0x5183728;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x8F2674;
...
constexpr ::std::ptrdiff_t dwPlayerResource = 0x3167FCC;
constexpr ::std::ptrdiff_t dwRadarBase = 0x516D2EC;
...
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4D29FA4;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x51841EC;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2964B200;
...
constexpr ::std::ptrdiff_t m_pitchClassPtr = 0x516D588;
