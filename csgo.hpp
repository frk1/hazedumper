...
constexpr ::std::ptrdiff_t dwEntityList = 0x4A497F4;
constexpr ::std::ptrdiff_t dwForceAttack = 0x2E8980C;
constexpr ::std::ptrdiff_t dwForceJump = 0x4EDEBF8;
constexpr ::std::ptrdiff_t dwGameDir = 0x654618;
constexpr ::std::ptrdiff_t dwGlobalVars = 0xA2236C;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x4F5F70C;
constexpr ::std::ptrdiff_t dwInput = 0x4E942E0;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xA2E4AC;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xA33D10;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x2E87830;
constexpr ::std::ptrdiff_t dwRadarBase = 0x4E7E50C;
constexpr ::std::ptrdiff_t dwSensitivity = 0xA33CB4;
constexpr ::std::ptrdiff_t dwViewMatrix = 0x4A3B384;
constexpr ::std::ptrdiff_t dwWeaponTable = 0x4E9096C;
