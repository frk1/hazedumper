...
constexpr ::std::int64_t timestamp = 1592001974;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwForceAttack = 0x317E7B8;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x317E7C4;
constexpr ::std::ptrdiff_t dwForceBackward = 0x317E80C;
constexpr ::std::ptrdiff_t dwForceForward = 0x317E7E8;
constexpr ::std::ptrdiff_t dwForceJump = 0x51F6EE4;
constexpr ::std::ptrdiff_t dwForceLeft = 0x317E800;
constexpr ::std::ptrdiff_t dwForceRight = 0x317E788;
constexpr ::std::ptrdiff_t dwGameDir = 0x6296F8;
constexpr ::std::ptrdiff_t dwGameRulesProxy = 0x526A1DC;
constexpr ::std::ptrdiff_t dwGetAllClasses = 0xD5F04C;
constexpr ::std::ptrdiff_t dwGlobalVars = 0x58AAD8;
constexpr ::std::ptrdiff_t dwGlowObjectManager = 0x5295080;
constexpr ::std::ptrdiff_t dwInput = 0x519E7F8;
constexpr ::std::ptrdiff_t dwInterfaceLinkList = 0x903084;
constexpr ::std::ptrdiff_t dwLocalPlayer = 0xD38BFC;
constexpr ::std::ptrdiff_t dwMouseEnable = 0xD3E7A0;
constexpr ::std::ptrdiff_t dwMouseEnablePtr = 0xD3E770;
constexpr ::std::ptrdiff_t dwPlayerResource = 0x317CB30;
constexpr ::std::ptrdiff_t dwRadarBase = 0x5181FBC;
constexpr ::std::ptrdiff_t dwSensitivity = 0xD4F9FC;
constexpr ::std::ptrdiff_t dwSensitivityPtr = 0xD4F9D0;
...
constexpr ::std::ptrdiff_t dwYawPtr = 0xD3E400;
constexpr ::std::ptrdiff_t dwZoomSensitivityRatioPtr = 0xD43648;
constexpr ::std::ptrdiff_t dwbSendPackets = 0xD409A;
constexpr ::std::ptrdiff_t dwppDirect3DDevice9 = 0xA7030;
constexpr ::std::ptrdiff_t find_hud_element = 0x291E1C30;
constexpr ::std::ptrdiff_t force_update_spectator_glow = 0x39F752;
constexpr ::std::ptrdiff_t interface_engine_cvar = 0x3E9EC;
constexpr ::std::ptrdiff_t is_c4_owner = 0x3AC210;
...
constexpr ::std::ptrdiff_t m_yawClassPtr = 0xD3E400;
