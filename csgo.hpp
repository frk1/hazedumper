...
constexpr ::std::int64_t timestamp = 1650959304;
namespace netvars {
...
constexpr ::std::ptrdiff_t dwForceAttack = 0x3203928;
constexpr ::std::ptrdiff_t dwForceAttack2 = 0x3203934;
...
constexpr ::std::ptrdiff_t find_hud_element = 0x2D595200;
